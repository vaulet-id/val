...
package ที่มีหน้าจอแล้วไม่มี `@main` จะ build ไม่ผ่าน แม้จะมีหน้าจอเดียวก็ตาม เพราะไม่อย่างนั้น
คนจะเห็นหน้าไหนก่อนขึ้นอยู่กับลำดับที่ไฟล์ถูกอ่าน และหนึ่งหน้าจอวันนี้คือสองหน้าจอในวันพรุ่งนี้
