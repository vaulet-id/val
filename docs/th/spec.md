...
- **คีย์เวิร์ดถูกจอง รวมสองคำที่ยังไม่มีอะไรใช้** `export` กับ `import` ถูกกันไว้สำหรับวันที่
  Micro App อยากได้ component จาก package อื่น package ถูกเซ็นแล้ว host ค่อยรันตามจังหวะ
  ของตัวเอง คำที่กลายเป็นคีย์เวิร์ดทีหลังจึงทำให้ package ที่เจ้าของไม่ได้แก้แล้วพังได้
...
package ที่มีหน้าจอมากกว่าหนึ่งแล้วไม่มี `@main` เลยจะถูกปฏิเสธ เพราะไม่อย่างนั้น
